# ইভেন্ট ড্যাশবোর্ড (Event Dashboard)

**ইভেন্ট ড্যাশবোর্ড** (`acd.toolforge.org`) হলো উইকিমিডিয়া আউটরিচ ইভেন্ট, কর্মশালা (workshop), এবং এডিটাথনের আয়োজকদের জন্য ডিজাইন করা একটি চমৎকার ও প্রিমিয়াম ওয়েব অ্যাপ্লিকেশন। এর সাহায্যে আয়োজকরা খুব সহজে এবং দ্রুত অংশগ্রহণকারীদের জন্য নতুন উইকিপিডিয়া অ্যাকাউন্ট তৈরি করে দিতে পারেন।
...
*   **লাইভ এডিটর লিডারবোর্ড ও অবদান ট্র্যাকিং (Live Leaderboard & Stats):** অংশগ্রহণকারীদের করা মোট সম্পাদনা (Edit Count), যোগকৃত ডেটা (Bytes), এবং আপলোডকৃত মিডিয়া ফাইল (Uploads) রিয়েল-টাইমে ট্র্যাক করে একটি লাইভ লিডারবোর্ড ও পরিসংখ্যান প্রদর্শন করে।
*   **ডাইনামিক উইকি টার্গেট ও অংশগ্রহণকারী নিয়ন্ত্রণ:** রেজিস্ট্রেশনের পর নতুন তৈরিকৃত অ্যাকাউন্টগুলো স্বয়ংক্রিয়ভাবে ইভেন্ট লিডারবোর্ডে যুক্ত হয়। এছাড়া অ্যাডমিন নির্দিষ্ট সময়সীমা, অবদান ট্র্যাকিং উইকি তালিকা নির্ধারণ এবং যেকোনো উইকিপিডিয়া ব্যবহারকারীকে ম্যানুয়ালি তালিকায় যোগ/বাদ দিতে পারেন।
...
6.  **"ইভেন্ট সেটিংস"** ট্যাব থেকে নতুন ইভেন্ট তৈরি করতে পারবেন, রেজিস্ট্রেশন বন্ধ/চালু করতে পারবেন, কাস্টম স্বাগত বার্তা ও অতিরিক্ত নির্দেশনা সেট করতে পারবেন, এবং ইভেন্টের শুরু ও শেষের সময়সীমা ও অবদান ট্র্যাকিং করার নির্দিষ্ট উইকি তালিকা নির্ধারণ করতে পারবেন।
7.  **"অংশগ্রহণকারী ব্যবস্থাপনা"** প্যানেল থেকে যেকোনো বিদ্যমান উইকিপিডিিয়া ব্যবহারকারীর নাম লিখে সরাসরি ইভেন্টে যুক্ত করতে পারেন অথবা তালিকা থেকে বাদ দিতে পারেন।
8.  **"পরিসংখ্যান"** পেজ থেকে চলমান ইভেন্টের লাইভ লিডারবোর্ড দেখা যাবে এবং অ্যাডমিনগণ চাইলে প্রতি ১ মিনিট পর পর ম্যানুয়ালি লাইভ ডেটা রিফ্রেশ করতে পারেন।
